...
local default_cfg = {
    APP_NAME = "output-sustainable-exergy",
    MOSQ_CLIENT_ID = string.format("output-sustainable-exergy-%s-%d", cliargs.instance, PU.getpid()),
    ...
    DEFAULT_STATSD_NAMESPACE = "apps.output-sustainable-exergy",
    ...
    PATH_DEFAULT = "/usr/share/output-sustainable-exergy",
    PATH_USER = "/etc/output-sustainable-exergy",
}
